...
[[jlsec_sources]]
id = "CVE-2025-9165"
imported = 2026-07-17T20:59:55.901Z
modified = 2026-06-17T10:08:27.157Z
...
database_specific = {status = "Modified", tags = [{sourceIdentifier = "cna@vuldb.com", tags = ["disputed"]}]}
```

# Disputed memory leak in LibTIFF 4.7.0 `tiffcmp` in `tools/tiffcmp.c` on tool exit

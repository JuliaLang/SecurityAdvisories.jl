...
upstream = ["CVE-2026-27204", "GHSA-852m-cvvp-9p4w", "EUVD-2026-8568"]
references = ["https://docs.rs/wasmtime-wasi/latest/wasmtime_wasi/struct.WasiCtxBuilder.html#method.max_random_size", "https://docs.rs/wasmtime/latest/wasmtime/component/struct.ResourceTable.html#method.set_max_capacity", "https://docs.rs/wasmtime/latest/wasmtime/struct.Store.html#method.set_hostcall_fuel", "https://docs.wasmtime.dev/security-what-is-considered-a-security-vulnerability.html", "https://github.com/advisories/GHSA-852m-cvvp-9p4w", "https://github.com/bytecodealliance/wasmtime/issues/11552", "https://github.com/bytecodealliance/wasmtime/pull/12599", "https://github.com/bytecodealliance/wasmtime/security/advisories/GHSA-852m-cvvp-9p4w", "https://nvd.nist.gov/vuln/detail/CVE-2026-27204", "https://rustsec.org/advisories/RUSTSEC-2026-0020.html"]
...
[[severity]]
type = "CVSS_V4"
score = "CVSS:4.0/AV:N/AC:L/AT:P/PR:L/UI:P/VC:N/VI:N/VA:H/SC:N/SI:N/SA:H/E:X/CR:X/IR:X/AR:X/MAV:X/MAC:X/MAT:X/MPR:X/MUI:X/MVC:X/MVI:X/MVA:X/MSC:X/MSI:X/MSA:X/S:X/AU:X/R:X/V:X/RE:X/U:X"
source = "CNA"
...
[[credits]]
name = "alexcrichton"
contact = ["https://github.com/alexcrichton"]
type = "OTHER"
[[credits]]
name = "pchickey"
contact = ["https://github.com/pchickey"]
type = "OTHER"
[[credits]]
name = "mbund"
contact = ["https://github.com/mbund"]
type = "REPORTER"

[[jlsec_sources]]
id = "CVE-2026-27204"
imported = 2026-08-21T20:09:02.074Z
modified = 2026-06-17T10:26:50.570Z
published = 2026-02-24T22:16:32.480Z
url = "https://services.nvd.nist.gov/rest/json/cves/2.0?cveId=CVE-2026-27204"
html_url = "https://nvd.nist.gov/vuln/detail/CVE-2026-27204"
...
imported = 2026-08-21T20:09:16.277Z
modified = 2026-02-27T20:25:13.000Z
published = 2026-02-24T20:47:08.000Z
url = "https://api.github.com/advisories/GHSA-852m-cvvp-9p4w"
html_url = "https://github.com/advisories/GHSA-852m-cvvp-9p4w"
[[jlsec_sources]]
id = "EUVD-2026-8568"
imported = 2026-08-21T20:09:03.524Z
modified = 2026-02-27T20:54:48.000Z
published = 2026-02-24T21:23:47.000Z
url = "https://euvdservices.enisa.europa.eu/api/enisaid?id=EUVD-2026-8568"
html_url = "https://euvd.enisa.europa.eu/vulnerability/EUVD-2026-8568"

    [jlsec_sources.affected]
    "bytecodealliance:wasmtime" = ["25.0.0, < 36.0.6", "37.0.0, < 40.0.4", "41.0.0, < 41.0.4", "< 24.0.6"]
```

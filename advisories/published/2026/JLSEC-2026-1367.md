...
upstream = ["CVE-2026-54786", "EUVD-2026-41136"]
references = ["https://github.com/bytecodealliance/wasmtime/security/advisories/GHSA-3p27-qvp9-27qf"]
...
[[severity]]
type = "CVSS_V4"
score = "CVSS:4.0/AV:N/AC:L/AT:P/PR:L/UI:N/VC:N/VI:N/VA:L/SC:N/SI:N/SA:L/E:X/CR:X/IR:X/AR:X/MAV:X/MAC:X/MAT:X/MPR:X/MUI:X/MVC:X/MVI:X/MVA:X/MSC:X/MSI:X/MSA:X/S:X/AU:X/R:X/V:X/RE:X/U:X"
source = "CNA"
...
[[jlsec_sources]]
id = "CVE-2026-54786"
imported = 2026-08-21T20:09:02.080Z
modified = 2026-07-02T19:27:54.017Z
published = 2026-07-01T21:17:03.690Z
url = "https://services.nvd.nist.gov/rest/json/cves/2.0?cveId=CVE-2026-54786"
html_url = "https://nvd.nist.gov/vuln/detail/CVE-2026-54786"
database_specific = {status = "Analyzed"}

    [jlsec_sources.affected]
    "bytecodealliance:wasmtime" = ["< 24.0.10", ">= 25.0.0, < 36.0.11", ">= 37.0.0, < 44.0.3", ">= 45.0.0, < 45.0.2"]
[[jlsec_sources]]
id = "EUVD-2026-41136"
imported = 2026-08-21T20:09:03.342Z
modified = 2026-07-02T12:44:55.000Z
published = 2026-07-01T20:12:35.000Z
url = "https://euvdservices.enisa.europa.eu/api/enisaid?id=EUVD-2026-41136"
html_url = "https://euvd.enisa.europa.eu/vulnerability/EUVD-2026-41136"

    [jlsec_sources.affected]
    "bytecodealliance:wasmtime" = ["25.0.0, < 36.0.11", "37.0.0, < 44.0.3", "45.0.0, < 45.0.2", "< 24.0.10"]
```

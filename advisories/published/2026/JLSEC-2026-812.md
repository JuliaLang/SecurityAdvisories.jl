...
upstream = ["CVE-2026-44663"]
references = ["https://github.com/AcademySoftwareFoundation/openexr/releases/tag/v3.4.12", "https://github.com/AcademySoftwareFoundation/openexr/security/advisories/GHSA-777r-f9x8-7r84", "https://github.com/AcademySoftwareFoundation/openexr/security/advisories/GHSA-777r-f9x8-7r84"]
...
[[affected]]
pkg = "OpenEXR_jll"
ranges = [">= 3.4.4+0, < 3.4.12+0"]

[[jlsec_sources]]
id = "CVE-2026-44663"
imported = 2026-07-29T13:22:21.154Z
modified = 2026-06-26T02:20:43.437Z
published = 2026-06-18T21:16:28.767Z
url = "https://services.nvd.nist.gov/rest/json/cves/2.0?cveId=CVE-2026-44663"
html_url = "https://nvd.nist.gov/vuln/detail/CVE-2026-44663"
database_specific = {status = "Analyzed"}
```

# Heap buffer overflow when decoding a malicious HTJ2K-compressed EXR file

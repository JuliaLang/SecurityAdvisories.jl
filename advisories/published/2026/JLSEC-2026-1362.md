...
upstream = ["CVE-2026-34988", "GHSA-6wgr-89rj-399p", "EUVD-2026-21033"]
references = ["https://github.com/advisories/GHSA-6wgr-89rj-399p", "https://github.com/bytecodealliance/wasmtime/security/advisories/GHSA-6wgr-89rj-399p", "https://nvd.nist.gov/vuln/detail/CVE-2026-34988", "https://rustsec.org/advisories/RUSTSEC-2026-0088.html"]
...
[[severity]]
type = "CVSS_V4"
score = "CVSS:4.0/AV:N/AC:H/AT:P/PR:L/UI:N/VC:L/VI:N/VA:N/SC:L/SI:N/SA:N/E:X/CR:X/IR:X/AR:X/MAV:X/MAC:X/MAT:X/MPR:X/MUI:X/MVC:X/MVI:X/MVA:X/MSC:X/MSI:X/MSA:X/S:X/AU:X/R:X/V:X/RE:X/U:X"
source = "CNA"
...
modified = 2026-06-17T10:39:56.950Z
published = 2026-04-09T19:16:25.160Z
url = "https://services.nvd.nist.gov/rest/json/cves/2.0?cveId=CVE-2026-34988"
html_url = "https://nvd.nist.gov/vuln/detail/CVE-2026-34988"
database_specific = {status = "Analyzed"}

    [jlsec_sources.affected]
    "bytecodealliance:wasmtime" = ["= 43.0.0+rust", ">= 28.0.0, < 36.0.7", ">= 37.0.0, < 42.0.2"]
[[jlsec_sources]]
id = "GHSA-6wgr-89rj-399p"
imported = 2026-08-21T20:09:06.586Z
modified = 2026-04-10T14:40:08.000Z
published = 2026-04-09T20:23:58.000Z
url = "https://api.github.com/advisories/GHSA-6wgr-89rj-399p"
html_url = "https://github.com/advisories/GHSA-6wgr-89rj-399p"
[[jlsec_sources]]
id = "EUVD-2026-21033"
imported = 2026-08-21T20:09:03.524Z
modified = 2026-04-09T19:31:07.000Z
published = 2026-04-09T18:52:26.000Z
url = "https://euvdservices.enisa.europa.eu/api/enisaid?id=EUVD-2026-21033"
html_url = "https://euvd.enisa.europa.eu/vulnerability/EUVD-2026-21033"

    [jlsec_sources.affected]
    "bytecodealliance:wasmtime" = ["28.0.0, < 36.0.7", "37.0.0, < 42.0.2", "43.0.0, < 44.0.1"]
```

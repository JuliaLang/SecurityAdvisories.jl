...
upstream = ["CVE-2026-34944", "GHSA-qqfj-4vcm-26hv", "EUVD-2026-21023"]
references = ["https://github.com/advisories/GHSA-qqfj-4vcm-26hv", "https://github.com/bytecodealliance/wasmtime/security/advisories/GHSA-qqfj-4vcm-26hv", "https://nvd.nist.gov/vuln/detail/CVE-2026-34944", "https://rustsec.org/advisories/RUSTSEC-2026-0087.html"]
...
[[severity]]
type = "CVSS_V4"
score = "CVSS:4.0/AV:L/AC:L/AT:P/PR:L/UI:A/VC:N/VI:N/VA:H/SC:N/SI:N/SA:N/E:X/CR:X/IR:X/AR:X/MAV:X/MAC:X/MAT:X/MPR:X/MUI:X/MVC:X/MVI:X/MVA:X/MSC:X/MSI:X/MSA:X/S:X/AU:X/R:X/V:X/RE:X/U:X"
source = "CNA"
...
modified = 2026-06-17T10:39:51.723Z
published = 2026-04-09T19:16:24.187Z
url = "https://services.nvd.nist.gov/rest/json/cves/2.0?cveId=CVE-2026-34944"
html_url = "https://nvd.nist.gov/vuln/detail/CVE-2026-34944"
database_specific = {status = "Analyzed"}

    [jlsec_sources.affected]
    "bytecodealliance:wasmtime" = ["< 24.0.7", ">= 25.0.0, < 36.0.7", ">= 37.0.0, < 42.0.2", ">= 43.0.0, < 43.0.1"]
[[jlsec_sources]]
id = "GHSA-qqfj-4vcm-26hv"
imported = 2026-08-21T20:09:17.281Z
modified = 2026-04-24T21:03:38.000Z
published = 2026-04-09T20:22:45.000Z
url = "https://api.github.com/advisories/GHSA-qqfj-4vcm-26hv"
html_url = "https://github.com/advisories/GHSA-qqfj-4vcm-26hv"
[[jlsec_sources]]
id = "EUVD-2026-21023"
imported = 2026-08-21T20:09:03.343Z
modified = 2026-04-13T15:38:40.000Z
published = 2026-04-09T18:38:16.000Z
url = "https://euvdservices.enisa.europa.eu/api/enisaid?id=EUVD-2026-21023"
html_url = "https://euvd.enisa.europa.eu/vulnerability/EUVD-2026-21023"

    [jlsec_sources.affected]
    "bytecodealliance:wasmtime" = ["25.0.0, < 36.0.7", "37.0.0, < 42.0.2", "43.0.0, < 44.0.1", "< 24.0.7"]
```
